...
if (cluster.isMaster) {
        ...
        worker.on('message', function (msg) {
          ...
          if (msg.result) {
            ...
            if (allItems.length % 1000 === 0 && allItems.length!==0){
              var output = fs.createWriteStream('data/cle_met_matches.json')
  ...
  process.on('message', (msg) => {
    if (msg.work){
      ...
      process.send({ result: {lowestScore:lowest, lowestTitle:lowestTitle, nyplTitle: msg.work.title, accessionCle: msg.work.accession_number, cleImg: msg.work.images.web}}, () =>{
